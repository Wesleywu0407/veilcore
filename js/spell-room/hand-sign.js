...
// How many frames a different count has to survive before it is believed. At
// the ~30Hz the tracker manages, four frames is about an eighth of a second --
// slower than a landmark glitch, faster than a person changing their mind.
export const SIGN_HOLD = 4;
 ...
 */
export function handSign(landmarks, state) {
  ...
  if (state.held >= SIGN_HOLD) state.sign = count;
